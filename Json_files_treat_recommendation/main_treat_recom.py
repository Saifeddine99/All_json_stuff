...
def main_get_treat():
    ...
    if(json_file is not None):
        ...
        #This function allows streamlit to extract data from submitted file
        ...
        #here we create a dataframe to show all data in the submitted file  
        ...
        #visit the "clinical_condition" function to understand more
        ...
        if (center_button or st.session_state.done_button):
            #This function displays the suggested treatment
